    ...
    public partial class InitDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Can Tho", "FPT", "Vietnam", "admin@estore.com", "admin@@" },
                    { 2, "Dong Thap", "Lifecom", "Vietnam", "phunlh2001@gmail.com", "123456" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ProductName", "UnitPrice", "UnitslnStock", "Weight" },
                values: new object[] { 3, 1, "iPhone 16", 1200m, 100, "40" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ProductName", "UnitPrice", "UnitslnStock", "Weight" },
                values: new object[] { 1, 2, "Samsung Galaxy", 200m, 100, "50" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ProductName", "UnitPrice", "UnitslnStock", "Weight" },
                values: new object[] { 2, 3, "Nokia 1280", 90m, 100, "90" });
